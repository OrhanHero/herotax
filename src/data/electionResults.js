...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    ...
    parties: [
      ...
      { id: "afd", name: "AfD", percent: 16.0, diff: +7.0, seats: 27, seatsDiff: +10, erststimmen: 15.8, erststimmenDiff: +6.8, direktmandate: 11, color: "#009ee0", barColor: "bg-sky-500" },
      ...
      { id: "spd", name: "SPD", percent: 12.1, diff: -6.2, seats: 21, seatsDiff: -13, erststimmen: 13.8, erststimmenDiff: -6.2, direktmandate: 7, color: "#E3000F", barColor: "bg-red-600" },
