...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    id: "zwischenstand",
    label: "Zwischenstand",
    tag: "VORLÄUFIGES AMTLICHES ENDERGEBNIS · 100 % (4.114/4.114)",
    statusBadge: "Vorläufiges amtliches Endergebnis · 4.114 von 4.114 Gebieten (100,0 %)",
    statusColor: "emerald",
    time: "21.09.2026 · 01:56:01 Uhr",
    source: "Landeswahlleiterin Berlin (wahlen-berlin.de/wahlen/BE2026/Afspraes/agh/)",
    turnout: "74,2 % (Urnen 44,1 % + Brief 30,1 %)",
    note: "Vorläufiges amtliches Endergebnis: Alle 4.114 Gebiete ausgezählt. Die Linke siegt mit 25,7 % (48 Sitze). BSW (4,7 %) und FDP (2,5 %) scheitern an der 5%-Hürde.",
    parties: [
