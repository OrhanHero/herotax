...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    ...
    statusColor: "purple",
    time: "20.09.2026 · 20:16:00 Uhr",
    source: "Landeswahlleiterin Berlin (wahlen-berlin.de/wahlen/BE2026/Afspraes/agh/)",
    turnout: "54,6 % (Zwischenstand 818.284 Wählende)",
    note: "Amtliches Zwischenergebnis wahlen-berlin.de: Knapp 50 % der Stimmgebiete erfasst. Die Linke behauptet Rang 1 mit 26,1 % Zweitstimmen und 24,5 % Erststimmen.",
    parties: [
      ...
      { id: "cdu", name: "CDU", percent: 18.1, diff: -10.1, seats: 31, erststimmen: 19.6, erststimmenDiff: -10.2, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 17.7, diff: +8.6, seats: 31, erststimmen: 17.4, erststimmenDiff: +8.4, direktmandate: 12, color: "#009ee0", barColor: "bg-sky-500" },
      { id: "gruene", name: "Grüne", percent: 13.6, diff: -4.8, seats: 23, erststimmen: 15.6, erststimmenDiff: -3.6, direktmandate: 8, color: "#46962b", barColor: "bg-emerald-600" },
      ...
      { id: "bsw", name: "BSW", percent: 5.0, diff: +5.0, seats: 9, erststimmen: 4.4, erststimmenDiff: +4.4, direktmandate: 0, color: "#ff6b00", barColor: "bg-orange-500" },
      { id: "fdp", name: "FDP", percent: 2.4, diff: -2.2, seats: 0, erststimmen: 2.1, erststimmenDiff: -1.7, direktmandate: 0, color: "#facc15", barColor: "bg-yellow-400" },
      { id: "sonstige", name: "Sonstige", percent: 5.5, diff: -3.5, seats: 0, erststimmen: 3.1, erststimmenDiff: -2.9, direktmandate: 0, color: "#64748b", barColor: "bg-slate-500" },
    ],
  },
