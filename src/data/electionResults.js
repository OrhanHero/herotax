...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    id: "zwischenstand",
    label: "Zwischenstand",
    tag: "ZWISCHENERGEBNIS · 4.069 VON 4.114 GEBIETEN (98,9 %)",
    statusBadge: "4.069 von 4.114 Gebieten ausgezählt (98,9 % · Stand 23:53 Uhr)",
    statusColor: "amber",
    time: "20.09.2026 · 23:53:17 Uhr",
    source: "Landeswahlleiterin Berlin (wahlen-berlin.de/wahlen/BE2026/Afspraes/agh/)",
    turnout: "74,5 % (Urnen 44,1 % + Brief 30,4 %)",
    note: "Amtliches Zwischenergebnis wahlen-berlin.de: 98,9 % der Gebiete ausgezählt. Die Linke führt deutlich. Auszählung läuft noch – 45 Gebiete ausstehend.",
    parties: [
      { id: "linke", name: "Die Linke", percent: 25.7, diff: +13.5, seats: 44, seatsDiff: +22, erststimmen: 24.1, erststimmenDiff: +11.8, direktmandate: 30, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 18.8, diff: -9.4, seats: 33, seatsDiff: -19, erststimmen: 20.2, erststimmenDiff: -9.5, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 16.1, diff: +7.0, seats: 27, seatsDiff: +10, erststimmen: 15.8, erststimmenDiff: +6.8, direktmandate: 11, color: "#009ee0", barColor: "bg-sky-500" },
      { id: "gruene", name: "Grüne", percent: 14.4, diff: -4.0, seats: 25, seatsDiff: -9, erststimmen: 16.5, erststimmenDiff: -2.6, direktmandate: 8, color: "#46962b", barColor: "bg-emerald-600" },
      { id: "spd", name: "SPD", percent: 12.1, diff: -6.3, seats: 21, seatsDiff: -13, erststimmen: 13.8, erststimmenDiff: -6.2, direktmandate: 7, color: "#E3000F", barColor: "bg-red-600" },
      { id: "bsw", name: "BSW", percent: 4.7, diff: +4.7, seats: 8, seatsDiff: +8, erststimmen: 4.2, erststimmenDiff: +4.2, direktmandate: 0, color: "#ff6b00", barColor: "bg-orange-500" },
  ...
  endergebnis: {
    ...
    label: "Aktuell",
    tag: "ZWISCHENERGEBNIS · 4.069 VON 4.114 GEBIETEN (98,9 %) 🔴",
    statusBadge: "Zwischenergebnis · 4.069 von 4.114 Gebieten (98,9 %) — Auszählung läuft",
    statusColor: "amber",
    time: "20.09.2026 · 23:53:17 Uhr",
    source: "Landeswahlleiterin Berlin / wahlen-berlin.de",
    turnout: "74,5 % (Urnen 44,1 % + Brief 30,4 %)",
    note: "Amtliches Zwischenergebnis: 98,9 % der Gebiete ausgezählt — 45 Gebiete noch ausstehend. Die Linke führt mit 25,7 % (Zweitstimmen). Auszählung läuft weiter.",
    parties: [
      { id: "linke", name: "Die Linke", percent: 25.7, diff: +13.5, seats: 44, seatsDiff: +22, erststimmen: 24.1, erststimmenDiff: +11.8, direktmandate: 30, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 18.8, diff: -9.4, seats: 33, seatsDiff: -19, erststimmen: 20.2, erststimmenDiff: -9.5, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 16.1, diff: +7.0, seats: 27, seatsDiff: +10, erststimmen: 15.8, erststimmenDiff: +6.8, direktmandate: 11, color: "#009ee0", barColor: "bg-sky-500" },
...
export const BVV_RESULTS = {
  time: "20.09.2026 · 23:53:10 Uhr",
  countedAreas: "4.073 von 4.114 Gebieten (99,0 %) — Auszählung läuft",
