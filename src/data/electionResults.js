...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    id: "zwischenstand",
    label: "Zwischenstand",
    tag: "ZWISCHENERGEBNIS · 4.090 VON 4.114 GEBIETEN (99,4 %)",
    statusBadge: "4.090 von 4.114 Gebieten ausgezählt (99,4 % · Stand 00:37 Uhr)",
    statusColor: "amber",
    time: "21.09.2026 · 00:37:50 Uhr",
    source: "Landeswahlleiterin Berlin (wahlen-berlin.de/wahlen/BE2026/Afspraes/agh/)",
    turnout: "74,3 % (Urnen 44,1 % + Brief 30,2 %)",
    note: "Amtliches Zwischenergebnis wahlen-berlin.de: 99,4 % der Gebiete ausgezählt. Die Linke führt deutlich. Auszählung auf der Zielgeraden – 24 Gebiete ausstehend.",
    parties: [
      ...
      { id: "cdu", name: "CDU", percent: 18.8, diff: -9.4, seats: 34, seatsDiff: -18, erststimmen: 20.3, erststimmenDiff: -9.4, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 16.1, diff: +7.1, seats: 29, seatsDiff: +12, erststimmen: 15.9, erststimmenDiff: +6.8, direktmandate: 11, color: "#009ee0", barColor: "bg-sky-500" },
      { id: "gruene", name: "Grüne", percent: 14.3, diff: -4.1, seats: 26, seatsDiff: -8, erststimmen: 16.5, erststimmenDiff: -2.7, direktmandate: 8, color: "#46962b", barColor: "bg-emerald-600" },
  ...
  endergebnis: {
    ...
    label: "Aktuell",
    tag: "ZWISCHENERGEBNIS · 4.090 VON 4.114 GEBIETEN (99,4 %) 🔴",
    statusBadge: "Zwischenergebnis · 4.090 von 4.114 Gebieten (99,4 %) — Auszählung läuft",
    statusColor: "amber",
    time: "21.09.2026 · 00:37:50 Uhr",
    source: "Landeswahlleiterin Berlin / wahlen-berlin.de",
    turnout: "74,3 % (Urnen 44,1 % + Brief 30,2 %)",
    note: "Amtliches Zwischenergebnis: 99,4 % der Gebiete ausgezählt — 24 Gebiete noch ausstehend. Die Linke führt mit 25,7 % (Zweitstimmen). Auszählung auf der Zielgeraden.",
    parties: [
      { id: "linke", name: "Die Linke", percent: 25.7, diff: +13.5, seats: 48, seatsDiff: +26, erststimmen: 24.1, erststimmenDiff: +11.8, direktmandate: 30, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 18.8, diff: -9.4, seats: 34, seatsDiff: -18, erststimmen: 20.3, erststimmenDiff: -9.4, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 16.1, diff: +7.1, seats: 29, seatsDiff: +12, erststimmen: 15.9, erststimmenDiff: +6.8, direktmandate: 11, color: "#009ee0", barColor: "bg-sky-500" },
...
export const BVV_RESULTS = {
  time: "21.09.2026 · 00:37:13 Uhr",
  countedAreas: "4.106 von 4.114 Gebieten (99,8 %) — Auszählung läuft",
