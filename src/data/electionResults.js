...
export const ELECTION_STAGES = {
  ...
  hochrechnung: {
    ...
    tag: "HOCHRECHNUNGS-SIMULATION · > 50 % AUSGEZÄHLT",
    statusBadge: "Hochrechnung · 1.148 von 2.257 Stimmbezirken ausgez. (> 50 %)",
    statusColor: "blue",
    time: "20.09.2026 · 19:35 Uhr",
    source: "Simulator · Auszählungs-Simulation",
    turnout: "68,1 % (Zwischenstand)",
    note: "Über die Hälfte der Wahlbezirke ausgezählt: Die Linke stabilisiert Vorsprung bei 27,5 %. CDU bei 21,5 %, SPD 18,9 %. Rot-Rot-Grün mit 107 Sitzen klar vorn.",
    parties: [
