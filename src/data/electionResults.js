...
export const ELECTION_STAGES = {
  ...
  hochrechnung: {
    ...
    tag: "HOCHRECHNUNGS-SIMULATION · LINKE-FÜHRUNG",
    statusBadge: "Hochrechnung: Die Linke behauptet Platz 1 mit 27,4 %",
    statusColor: "blue",
    time: "20.09.2026 · 19:45 Uhr",
    source: "Simulator · Auszählungs-Simulation",
    turnout: "67,8 % (Zwischenstand)",
    note: "Hochrechnungssimulation stabilisiert den Linke-Sieg: Linke bei 27,4 % klar vor CDU und SPD. Rot-Rot-Grün mit stabiler Zweidrittel-Mehrheit.",
    parties: [
      { id: "linke", name: "Die Linke", percent: 27.4, diff: +15.2, seats: 48, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 21.6, diff: -6.6, seats: 36, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "spd", name: "SPD", percent: 19.0, diff: +0.6, seats: 32, color: "#E3000F", barColor: "bg-red-600" },
      { id: "gruene", name: "Grüne", percent: 16.5, diff: -1.9, seats: 27, color: "#46962b", barColor: "bg-emerald-600" },
      { id: "afd", name: "AfD", percent: 10.2, diff: +1.1, seats: 16, color: "#009ee0", barColor: "bg-sky-500" },
      { id: "bsw", name: "BSW", percent: 4.8, diff: +4.8, seats: 0, color: "#ff6b00", barColor: "bg-orange-500" },
      { id: "sonstige", name: "Sonstige", percent: 0.5, diff: -13.2, seats: 0, color: "#64748b", barColor: "bg-slate-500" },
    ],
  },
