...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    ...
    parties: [
      { id: "linke", name: "Die Linke", percent: 26.0, diff: +13.8, seats: 46, erststimmen: 24.4, erststimmenDiff: +12.1, direktmandate: 30, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 18.4, diff: -9.8, seats: 33, erststimmen: 19.9, erststimmenDiff: -9.8, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 17.0, diff: +7.9, seats: 30, erststimmen: 16.8, erststimmenDiff: +7.8, direktmandate: 12, color: "#009ee0", barColor: "bg-sky-500" },
      { id: "gruene", name: "Grüne", percent: 13.8, diff: -4.6, seats: 25, erststimmen: 15.8, erststimmenDiff: -3.3, direktmandate: 8, color: "#46962b", barColor: "bg-emerald-600" },
      { id: "spd", name: "SPD", percent: 11.8, diff: -6.6, seats: 21, erststimmen: 13.6, erststimmenDiff: -6.3, direktmandate: 6, color: "#E3000F", barColor: "bg-red-600" },
      { id: "bsw", name: "BSW", percent: 4.9, diff: +4.9, seats: 4, erststimmen: 4.3, erststimmenDiff: +4.3, direktmandate: 0, color: "#ff6b00", barColor: "bg-orange-500" },
      { id: "fdp", name: "FDP", percent: 2.5, diff: -2.1, seats: 0, erststimmen: 2.2, erststimmenDiff: -1.7, direktmandate: 0, color: "#facc15", barColor: "bg-yellow-400" },
      { id: "sonstige", name: "Sonstige", percent: 5.6, diff: -3.4, seats: 0, erststimmen: 3.0, erststimmenDiff: -3.0, direktmandate: 0, color: "#64748b", barColor: "bg-slate-500" },
    ],
  },
