...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    id: "zwischenstand",
    label: "Zwischenstand",
    tag: "ZWISCHENERGEBNIS · 4.078 VON 4.114 GEBIETEN (99,1 %)",
    statusBadge: "4.078 von 4.114 Gebieten ausgezählt (99,1 % · Stand 00:12 Uhr)",
    statusColor: "amber",
    time: "21.09.2026 · 00:12:21 Uhr",
    source: "Landeswahlleiterin Berlin (wahlen-berlin.de/wahlen/BE2026/Afspraes/agh/)",
    turnout: "74,4 % (Urnen 44,1 % + Brief 30,3 %)",
    note: "Amtliches Zwischenergebnis wahlen-berlin.de: 99,1 % der Gebiete ausgezählt. Die Linke führt deutlich. Auszählung läuft noch – 36 Gebiete ausstehend.",
    parties: [
  ...
  endergebnis: {
    ...
    label: "Aktuell",
    tag: "ZWISCHENERGEBNIS · 4.078 VON 4.114 GEBIETEN (99,1 %) 🔴",
    statusBadge: "Zwischenergebnis · 4.078 von 4.114 Gebieten (99,1 %) — Auszählung läuft",
    statusColor: "amber",
    time: "21.09.2026 · 00:12:21 Uhr",
    source: "Landeswahlleiterin Berlin / wahlen-berlin.de",
    turnout: "74,4 % (Urnen 44,1 % + Brief 30,3 %)",
    note: "Amtliches Zwischenergebnis: 99,1 % der Gebiete ausgezählt — 36 Gebiete noch ausstehend. Die Linke führt mit 25,7 % (Zweitstimmen). Auszählung läuft weiter.",
    parties: [
      { id: "linke", name: "Die Linke", percent: 25.7, diff: +13.5, seats: 48, seatsDiff: +26, erststimmen: 24.1, erststimmenDiff: +11.8, direktmandate: 30, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 18.8, diff: -9.5, seats: 34, seatsDiff: -18, erststimmen: 20.2, erststimmenDiff: -9.5, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 16.1, diff: +7.0, seats: 29, seatsDiff: +12, erststimmen: 15.8, erststimmenDiff: +6.8, direktmandate: 11, color: "#009ee0", barColor: "bg-sky-500" },
...
export const BVV_RESULTS = {
  time: "21.09.2026 · 00:13:03 Uhr",
  countedAreas: "4.095 von 4.114 Gebieten (99,5 %) — Auszählung läuft",
