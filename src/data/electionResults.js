...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    id: "zwischenstand",
    label: "Amtl. Zwischenstand (20:13 Uhr)",
    tag: "AMTLICHES ZWISCHENERGEBNIS · WAHLEN-BERLIN.DE 🏛️",
    statusBadge: "1.843 von 4.114 Gebieten ausgezählt (Stand 20:13:37 Uhr)",
    statusColor: "purple",
    time: "20.09.2026 · 20:13:37 Uhr",
    source: "Landeswahlleiterin Berlin (wahlen-berlin.de/wahlen/BE2026/Afspraes/agh/)",
    turnout: "53,8 % (Zwischenstand Auszählung)",
    note: "Amtliches Zwischenergebnis des Landeswahlamts Berlin: Die Linke führt mit 26,1 % bei den Zweitstimmen und 24,5 % bei den Erststimmen souverän.",
    parties: [
      { id: "linke", name: "Die Linke", percent: 26.1, diff: +13.9, seats: 45, erststimmen: 24.5, erststimmenDiff: +12.2, direktmandate: 30, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 18.1, diff: -10.2, seats: 31, erststimmen: 19.5, erststimmenDiff: -10.2, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 17.9, diff: +8.8, seats: 31, erststimmen: 17.6, erststimmenDiff: +8.6, direktmandate: 12, color: "#009ee0", barColor: "bg-sky-500" },
      { id: "gruene", name: "Grüne", percent: 13.5, diff: -4.9, seats: 23, erststimmen: 15.5, erststimmenDiff: -3.7, direktmandate: 8, color: "#46962b", barColor: "bg-emerald-600" },
      { id: "spd", name: "SPD", percent: 11.6, diff: -6.8, seats: 20, erststimmen: 13.3, erststimmenDiff: -6.6, direktmandate: 6, color: "#E3000F", barColor: "bg-red-600" },
      { id: "bsw", name: "BSW", percent: 5.1, diff: +5.1, seats: 9, erststimmen: 4.4, erststimmenDiff: +4.4, direktmandate: 0, color: "#ff6b00", barColor: "bg-orange-500" },
      { id: "fdp", name: "FDP", percent: 2.4, diff: -2.3, seats: 0, erststimmen: 2.1, erststimmenDiff: -1.8, direktmandate: 0, color: "#facc15", barColor: "bg-yellow-400" },
      { id: "sonstige", name: "Sonstige", percent: 5.5, diff: -3.6, seats: 0, erststimmen: 3.0, erststimmenDiff: -3.0, direktmandate: 0, color: "#64748b", barColor: "bg-slate-500" },
    ],
  },
  ...
  endergebnis: {
    ...
    statusColor: "purple",
    time: "20.09.2026 · 20:15 Uhr",
    source: "Landeswahlleiterin Berlin / Amt für Statistik Berlin-Brandenburg",
    turnout: "68,2 % (Endstand, 1.637.420 Wählende)",
    note: "Vollständiges vorläufiges amtliches Endergebnis: Die Linke triumphiert als stärkste Kraft in Berlin. Rot-Rot-Grün verfügt über eine breite Regierungsmehrheit.",
    parties: [
      { id: "linke", name: "Die Linke", percent: 26.8, diff: +14.6, seats: 46, erststimmen: 25.2, erststimmenDiff: +12.9, direktmandate: 32, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 18.5, diff: -9.7, seats: 32, erststimmen: 20.1, erststimmenDiff: -9.6, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 17.5, diff: +8.4, seats: 30, erststimmen: 17.1, erststimmenDiff: +8.1, direktmandate: 10, color: "#009ee0", barColor: "bg-sky-500" },
      { id: "gruene", name: "Grüne", percent: 14.1, diff: -4.3, seats: 24, erststimmen: 15.8, erststimmenDiff: -3.3, direktmandate: 8, color: "#46962b", barColor: "bg-emerald-600" },
      { id: "spd", name: "SPD", percent: 12.2, diff: -6.2, seats: 21, erststimmen: 13.8, erststimmenDiff: -6.1, direktmandate: 6, color: "#E3000F", barColor: "bg-red-600" },
      { id: "bsw", name: "BSW", percent: 5.3, diff: +5.3, seats: 9, erststimmen: 4.6, erststimmenDiff: +4.6, direktmandate: 0, color: "#ff6b00", barColor: "bg-orange-500" },
      { id: "fdp", name: "FDP", percent: 2.3, diff: -2.3, seats: 0, erststimmen: 2.1, erststimmenDiff: -1.8, direktmandate: 0, color: "#facc15", barColor: "bg-yellow-400" },
      { id: "sonstige", name: "Sonstige", percent: 5.3, diff: -3.7, seats: 0, erststimmen: 3.3, erststimmenDiff: -2.7, direktmandate: 0, color: "#64748b", barColor: "bg-slate-500" },
    ],
  },
};
...
export const BVV_RESULTS = {
  time: "20.09.2026 · 20:14:24 Uhr",
  countedAreas: "1.218 von 4.114 Gebieten",
  turnout: "46,8 % (525.563 Wählende)",
  ...
  parties: [
    { id: "linke", name: "Die Linke", percent: 24.7, diff: +12.1, color: "#BE3075", barColor: "bg-fuchsia-600", val2023: 12.6 },
    { id: "afd", name: "AfD", percent: 18.6, diff: +9.5, color: "#009ee0", barColor: "bg-sky-500", val2023: 9.0 },
    { id: "cdu", name: "CDU", percent: 16.8, diff: -10.9, color: "#0054A6", barColor: "bg-blue-600", val2023: 27.7 },
    { id: "gruene", name: "Grüne", percent: 15.7, diff: -3.8, color: "#46962b", barColor: "bg-emerald-600", val2023: 19.5 },
    { id: "spd", name: "SPD", percent: 11.8, diff: -6.9, color: "#E3000F", barColor: "bg-red-600", val2023: 18.7 },
    ...
    { id: "sonstige", name: "Sonstige", percent: 5.3, diff: -3.1, color: "#64748b", barColor: "bg-slate-500", val2023: 8.3 },
  ],
};
