...
export const ELECTION_STAGES = {
  ...
  endergebnis: {
    ...
    statusBadge: "Amtliches vorläufiges Endergebnis · 2.257 von 2.257 Bezirken (100 %)",
    statusColor: "purple",
    time: "20.09.2026 · 20:00 Uhr",
    source: "Landeswahlleiterin Berlin / Amt für Statistik",
    turnout: "68,2 % (Endstand, 1.637.420 Wähler)",
    note: "Vollständige Auszählung aller 2.257 Urnen- und Briefwahlbezirke: Die Linke siegt mit 27,5 % (48 Sitze). Rot-Rot-Grün verfügt über 107 Mandate.",
    parties: [
      { id: "linke", name: "Die Linke", percent: 27.5, diff: +15.3, seats: 48, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 21.5, diff: -6.7, seats: 36, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "spd", name: "SPD", percent: 19.1, diff: +0.7, seats: 32, color: "#E3000F", barColor: "bg-red-600" },
