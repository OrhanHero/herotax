...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    id: "zwischenstand",
    label: "Zwischenstand",
    tag: "AMTLICHES ZWISCHENERGEBNIS · 4.095 VON 4.114 GEBIETEN",
    statusBadge: "4.095 von 4.114 Gebieten ausgezählt (Stand 21:15:00 Uhr)",
    statusColor: "purple",
    time: "20.09.2026 · 21:15:00 Uhr",
    source: "Landeswahlleiterin Berlin (wahlen-berlin.de/wahlen/BE2026/Afspraes/agh/)",
    turnout: "68,1 % (Zwischenstand 1.632.900 Wählende)",
    note: "Amtliches Zwischenergebnis wahlen-berlin.de: 99,5 % der Gebiete ausgezählt. Die Linke gewinnt Berlin mit 44 Sitzen. Landeswahlleitung verkündet in Kürze das vorläufige amtliche Endergebnis.",
    parties: [
