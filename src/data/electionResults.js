...
export const ELECTION_STAGES = {
  ...
  hochrechnung: {
    ...
    tag: "HOCHRECHNUNGS-SIMULATION · ~ 85 % AUSGEZÄHLT",
    statusBadge: "Hochrechnung · 1.920 von 2.257 Stimmbezirken ausgez. (~ 85 %)",
    statusColor: "blue",
    time: "20.09.2026 · 19:45 Uhr",
    source: "Simulator · Auszählungs-Simulation",
    turnout: "68,3 % (Zwischenstand)",
    note: "Endspurt der Auszählung mit 85 % der Bezirke: Der historische Sieg der Linken (27,5 %) ist rechnerisch gesichert. Erste Reaktionen der Parteispitzen aus dem Roten Rathaus.",
    parties: [
