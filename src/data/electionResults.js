...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    id: "zwischenstand",
    label: "Zwischenstand",
    tag: "ZWISCHENERGEBNIS · 4.103 VON 4.114 GEBIETEN (99,7 %)",
    statusBadge: "4.103 von 4.114 Gebieten ausgezählt (99,7 % · Stand 01:04 Uhr)",
    statusColor: "amber",
    time: "21.09.2026 · 01:04:08 Uhr",
    source: "Landeswahlleiterin Berlin (wahlen-berlin.de/wahlen/BE2026/Afspraes/agh/)",
    turnout: "74,2 % (Urnen 44,1 % + Brief 30,1 %)",
    note: "Amtliches Zwischenergebnis wahlen-berlin.de: 99,7 % der Gebiete ausgezählt. Die Linke führt deutlich. Auszählung auf der Zielgeraden – 11 Gebiete ausstehend.",
    parties: [
  ...
  endergebnis: {
    ...
    label: "Aktuell",
    tag: "ZWISCHENERGEBNIS · 4.103 VON 4.114 GEBIETEN (99,7 %) 🔴",
    statusBadge: "Zwischenergebnis · 4.103 von 4.114 Gebieten (99,7 %) — Auszählung läuft",
    statusColor: "amber",
    time: "21.09.2026 · 01:04:08 Uhr",
    source: "Landeswahlleiterin Berlin / wahlen-berlin.de",
    turnout: "74,2 % (Urnen 44,1 % + Brief 30,1 %)",
    note: "Amtliches Zwischenergebnis: 99,7 % der Gebiete ausgezählt — 11 Gebiete noch ausstehend. Die Linke führt mit 25,7 % (Zweitstimmen). Auszählung auf der Zielgeraden.",
    parties: [
      { id: "linke", name: "Die Linke", percent: 25.7, diff: +13.5, seats: 48, seatsDiff: +26, erststimmen: 24.1, erststimmenDiff: +11.8, direktmandate: 30, color: "#BE3075", barColor: "bg-fuchsia-600" },
      { id: "cdu", name: "CDU", percent: 18.8, diff: -9.5, seats: 34, seatsDiff: -18, erststimmen: 20.3, erststimmenDiff: -9.5, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 16.2, diff: +7.1, seats: 29, seatsDiff: +12, erststimmen: 15.9, erststimmenDiff: +6.9, direktmandate: 11, color: "#009ee0", barColor: "bg-sky-500" },
