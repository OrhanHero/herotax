...
export const ELECTION_STAGES = {
  ...
  zwischenstand: {
    id: "zwischenstand",
    label: "Zwischenstand",
    tag: "AMTLICHES ZWISCHENERGEBNIS · 2.306 VON 4.114 GEBIETEN",
    statusBadge: "2.306 von 4.114 Gebieten ausgezählt (Stand 20:26:00 Uhr)",
    statusColor: "purple",
    time: "20.09.2026 · 20:26:00 Uhr",
    source: "Landeswahlleiterin Berlin (wahlen-berlin.de/wahlen/BE2026/Afspraes/agh/)",
    turnout: "57,7 % (Zwischenstand 975.936 Wählende)",
    note: "Amtliches Zwischenergebnis wahlen-berlin.de: Über 56 % der Gebiete ausgezählt. Die Linke führt mit 26,1 % Zweitstimmen und 24,5 % Erststimmen unverändert stabil.",
    parties: [
      ...
      { id: "cdu", name: "CDU", percent: 18.3, diff: -9.9, seats: 32, erststimmen: 19.7, erststimmenDiff: -10.0, direktmandate: 22, color: "#0054A6", barColor: "bg-blue-600" },
      { id: "afd", name: "AfD", percent: 17.2, diff: +8.2, seats: 30, erststimmen: 17.0, erststimmenDiff: +8.0, direktmandate: 12, color: "#009ee0", barColor: "bg-sky-500" },
      { id: "gruene", name: "Grüne", percent: 13.7, diff: -4.7, seats: 24, erststimmen: 15.7, erststimmenDiff: -3.4, direktmandate: 8, color: "#46962b", barColor: "bg-emerald-600" },
      { id: "spd", name: "SPD", percent: 11.7, diff: -6.7, seats: 20, erststimmen: 13.5, erststimmenDiff: -6.5, direktmandate: 6, color: "#E3000F", barColor: "bg-red-600" },
      { id: "bsw", name: "BSW", percent: 5.0, diff: +5.0, seats: 8, erststimmen: 4.4, erststimmenDiff: +4.4, direktmandate: 0, color: "#ff6b00", barColor: "bg-orange-500" },
      ...
      { id: "sonstige", name: "Sonstige", percent: 5.6, diff: -3.4, seats: 0, erststimmen: 3.1, erststimmenDiff: -2.9, direktmandate: 0, color: "#64748b", barColor: "bg-slate-500" },
    ],
  },
...
export const BVV_RESULTS = {
  time: "20.09.2026 · 20:26:41 Uhr",
  countedAreas: "1.678 von 4.114 Gebieten",
  turnout: "48,7 % (728.884 Wählende)",
  ...
  parties: [
    ...
    { id: "afd", name: "AfD", percent: 18.0, diff: +9.0, color: "#009ee0", barColor: "bg-sky-500", val2023: 9.0 },
    ...
    { id: "spd", name: "SPD", percent: 11.8, diff: -6.8, color: "#E3000F", barColor: "bg-red-600", val2023: 18.7 },
    ...
    { id: "sonstige", name: "Sonstige", percent: 5.4, diff: -3.0, color: "#64748b", barColor: "bg-slate-500", val2023: 8.3 },
  ],
};
