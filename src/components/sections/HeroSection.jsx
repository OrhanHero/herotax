            ...
            <div className="group relative rounded-2xl p-5 sm:p-6 transition-all duration-300 bg-slate-900/90 backdrop-blur-md border border-blue-500/35 hover:border-blue-500/60 shadow-xl overflow-hidden">
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 mb-3 relative z-10">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-amber-500/20 text-amber-300 border border-amber-500/40 tracking-wide font-mono">
                    ...
                    ZWISCHENERGEBNIS 99,7 % · AUSZÄHLUNG LÄUFT 🔴
                  </span>
                  <span className="text-[11px] font-mono font-semibold text-slate-300 bg-slate-800/80 px-2 py-0.5 rounded border border-slate-700/70">
                    Berlin-Wahl 2026 · AGH &amp; BVV · 4.102 / 4.114 Gebiete
                  </span>
                </div>
                <span className="text-xs text-amber-300/90 font-mono font-bold">
                  21. September 2026 · 01:05 UHR · PRAXIS- &amp; BERATER-RADAR 🗳️
                </span>
              </div>
              ...
              >
                <h3
                  ...
                  style={{ ...fontDisplay }}
                >
                  Berlin-Wahl 01:05 Uhr: Auszählung auf der Zielgeraden – 12 Gebiete ausstehend, Linke führt deutlich
                </h3>
              </a>

              {/* Story Teaser */}
              <p className="text-sm text-slate-300 leading-relaxed mb-4 relative z-10">
                99,7 % der Gebiete ausgezählt: Die Linke führt bei AGH-Zweitstimmen mit 25,7 %, CDU bei 18,8 %, AfD bei 16,2 %. BVV-Auszählung bei 99,9 % (4.108 / 4.114). BSW (4,7 %) verfehlt 5%-Hürde (0 Sitze). Endgültige Sitzverteilung und Koalitionsgespräche nach vollständiger Auszählung.
              </p>
